  ...
  return (
    <div className="pt-24 pb-20 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl md:text-4xl font-display font-extrabold text-white mb-8 md:10 tracking-tight">Shopping <span className="text-primary">Bag</span></h1>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
          {/* Cart Items List */}
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            {items.map((item) => (
              <div key={item.id} className="glass p-4 md:p-6 rounded-2xl md:rounded-3xl border border-white/5 flex flex-row items-center space-x-4 md:space-x-6 animate-fade-in">
          ...
          <div className="lg:col-span-1">
            <div className="glass p-6 md:p-8 rounded-2xl md:rounded-[2rem] border border-white/10 sticky top-28 space-y-6">
